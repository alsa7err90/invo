            ...
            <div class="modal-body">
                ...
                <div class="modal_body" style="display: none">
                    <form method="post" id="form_ajax_post_edit" data-action="" data-id=""
                        ...
                        <x-inputs.list_users_invo className="col-12" />
                        <div class="col-12">
                            <label>رمز الكرسي </label>
                            <div id="type" type="text"> </div>
                        </div>
                        <x-buttons.submit className="col-12" label="تحديث" /> 
                    </form> 
                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
                        data-bs-dismiss="modal" id="postition_table" data-src=""> مخطط الكرسي</button>
                </div>
            </div>
        </div>
    </div>
